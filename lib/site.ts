...
export const SITE = {
  name: "theCareLineMD",
  shortName: "theCareLineMD",
  url: (process.env.NEXT_PUBLIC_SITE_URL || "https://www.thecarelinemd.com").replace(/\/$/, ""),
  description:
    "theCareLineMD helps healthcare organizations get paid faster and run smarter with expert medical billing, revenue cycle management, and an EHR, PMS, and patient portal built to work together.",
